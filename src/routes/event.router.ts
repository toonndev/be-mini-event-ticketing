...
import { getEvents, getEventById, getCategories, createEvent, updateEvent, deleteEvent, liveEvent, liveAllEvents } from '../controllers/event.controller';
